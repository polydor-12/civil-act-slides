...
`],at=()=>{};var R={};const K=function(e){const t=[];let s=0;for(let i=0;i<e.length;i++){let l=e.charCodeAt(i);l<128?t[s++]=l:l<2048?(t[s++]=l>>6|192,t[s++]=l&63|128):(l&64512)===55296&&i+1<e.length&&(e.charCodeAt(i+1)&64512)===56320?(l=65536+((l&1023)<<10)+(e.charCodeAt(++i)&1023),t[s++]=l>>18|240,t[s++]=l>>12&63|128,t[s++]=l>>6&63|128,t[s++]=l&63|128):(t[s++]=l>>12|224,t[s++]=l>>6&63|128,t[s++]=l&63|128)}return t},dt=function(e){const t=[];let s=0,i=0;for(;s<e.length;){const l=e[s++];if(l<128)t[i++]=String.fromCharCode(l);else if(l>191&&l<224){const a=e[s++];t[i++]=String.fromCharCode((l&31)<<6|a&63)}else if(l>239&&l<365){const a=e[s++],d=e[s++],n=e[s++],r=((l&7)<<18|(a&63)<<12|(d&63)<<6|n&63)-65536;t[i++]=String.fromCharCode(55296+(r>>10)),t[i++]=String.fromCharCode(56320+(r&1023))}else{const a=e[s++],d=e[s++];t[i++]=String.fromCharCode((l&15)<<12|(a&63)<<6|d&63)}}return t.join("")},J={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(e,t){if(!Array.isArray(e))throw Error("encodeByteArray takes an array as a parameter");this.init_();const s=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,i=[];for(let l=0;l<e.length;l+=3){const a=e[l],d=l+1<e.length,n=d?e[l+1]:0,r=l+2<e.length,c=r?e[l+2]:0,p=a>>2,x=(a&3)<<4|n>>4;let w=(n&15)<<2|c>>6,y=c&63;r||(y=64,d||(w=64)),i.push(s[p],s[x],s[w],s[y])}return i.join("")},encodeString(e,t){return this.HAS_NATIVE_SUPPORT&&!t?btoa(e):this.encodeByteArray(K(e),t)},decodeString(e,t){return this.HAS_NATIVE_SUPPORT&&!t?atob(e):dt(this.decodeStringToByteArray(e,t))},decodeStringToByteArray(e,t){this.init_();const s=t?this.charToByteMapWebSafe_:this.charToByteMap_,i=[];for(let l=0;l<e.length;){const a=s[e.charAt(l++)],n=l<e.length?s[e.charAt(l)]:0;++l;const c=l<e.length?s[e.charAt(l)]:64;++l;const x=l<e.length?s[e.charAt(l)]:64;if(++l,a==null||n==null||c==null||x==null)throw new ct;const w=a<<2|n>>4;if(i.push(w),c!==64){const y=n<<4&240|c>>2;if(i.push(y),x!==64){const lt=c<<6&192|x;i.push(lt)}}}return i},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let e=0;e<this.ENCODED_VALS.length;e++)this.byteToCharMap_[e]=this.ENCODED_VALS.charAt(e),this.charToByteMap_[this.byteToCharMap_[e]]=e,this.byteToCharMapWebSafe_[e]=this.ENCODED_VALS_WEBSAFE.charAt(e),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[e]]=e,e>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(e)]=e,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(e)]=e)}}};class ct extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const rt=function(e){const t=K(e);return J.encodeByteArray(t,!0)},Q=function(e){return rt(e).replace(/\./g,"")},nt=function(e){try{return J.decodeString(e,!0)}catch(t){console.error("base64Decode failed: ",t)}return null};function ot(){if(typeof self<"u")return self;if(typeof window<"u")return window;if(typeof global<"u")return global;throw new Error("Unable to locate global object.")}const xt=()=>ot().__FIREBASE_DEFAULTS__,bt=()=>{if(typeof process>"u"||typeof R>"u")return;const e=R.__FIREBASE_DEFAULTS__;if(e)return JSON.parse(e)},pt=()=>{if(typeof document>"u")return;let e;try{e=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=e&&nt(e[1]);return t&&JSON.parse(t)},ft=()=>{try{return at()||xt()||bt()||pt()}catch(e){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${e}`);return}},mt=()=>ft()?.config;class vt{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise((t,s)=>{this.resolve=t,this.reject=s})}wrapCallback(t){return(s,i)=>{s?this.reject(s):this.resolve(i),typeof t=="function"&&(this.promise.catch(()=>{}),t.length===1?t(s):t(s,i))}}}function ht(){try{return typeof indexedDB=="object"}catch{return!1}}function ut(){return new Promise((e,t)=>{try{let s=!0;const i="validate-browser-context-for-indexeddb-analytics-module",l=self.indexedDB.open(i);l.onsuccess=()=>{l.result.close(),s||self.indexedDB.deleteDatabase(i),e(!0)},l.onupgradeneeded=()=>{s=!1},l.onerror=()=>{t(l.error?.message||"")}}catch(s){t(s)}})}const gt="FirebaseError";class g extends Error{constructor(t,s,i){super(s),this.code=t,this.customData=i,this.name=gt,Object.setPrototypeOf(this,g.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Z.prototype.create)}}class Z{constructor(t,s,i){this.service=t,this.serviceName=s,this.errors=i}create(t,...s){const i=s[0]||{},l=`${this.service}/${t}`,a=this.errors[t],d=a?wt(a,i):"Error",n=`${this.serviceName}: ${d} (${l}).`;return new g(l,n,i)}}function wt(e,t){return e.replace(yt,(s,i)=>{const l=t[i];return l!=null?String(l):`<${i}?>`})}const yt=/\{\$([^}]+)}/g;function B(e,t){if(e===t)return!0;const s=Object.keys(e),i=Object.keys(t);for(const l of s){if(!i.includes(l))return!1;const a=e[l],d=t[l];if(Y(a)&&Y(d)){if(!B(a,d))return!1}else if(a!==d)return!1}for(const l of i)if(!s.includes(l))return!1;return!0}function Y(e){return e!==null&&typeof e=="object"}class j{constructor(t,s,i){this.name=t,this.instanceFactory=s,this.type=i,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}const m="[DEFAULT]";class kt{constructor(t,s){this.name=t,this.container=s,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const s=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(s)){const i=new vt;if(this.instancesDeferred.set(s,i),this.isInitialized(s)||this.shouldAutoInitialize())try{const l=this.getOrInitializeService({instanceIdentifier:s});l&&i.resolve(l)}catch{}}return this.instancesDeferred.get(s).promise}getImmediate(t){const s=this.normalizeInstanceIdentifier(t?.identifier),i=t?.optional??!1;if(this.isInitialized(s)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:s})}catch(l){if(i)return null;throw l}else{if(i)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(Dt(t))try{this.getOrInitializeService({instanceIdentifier:m})}catch{}for(const[s,i]of this.instancesDeferred.entries()){const l=this.normalizeInstanceIdentifier(s);try{const a=this.getOrInitializeService({instanceIdentifier:l});i.resolve(a)}catch{}}}}clearInstance(t=m){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(s=>"INTERNAL"in s).map(s=>s.INTERNAL.delete()),...t.filter(s=>"_delete"in s).map(s=>s._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=m){return this.instances.has(t)}getOptions(t=m){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:s={}}=t,i=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(i))throw Error(`${this.name}(${i}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const l=this.getOrInitializeService({instanceIdentifier:i,options:s});for(const[a,d]of this.instancesDeferred.entries()){const n=this.normalizeInstanceIdentifier(a);i===n&&d.resolve(l)}return l}onInit(t,s){const i=this.normalizeInstanceIdentifier(s),l=this.onInitCallbacks.get(i)??new Set;l.add(t),this.onInitCallbacks.set(i,l);const a=this.instances.get(i);return a&&t(a,i),()=>{l.delete(t)}}invokeOnInitCallbacks(t,s){const i=this.onInitCallbacks.get(s);if(i)for(const l of i)try{l(t,s)}catch{}}getOrInitializeService({instanceIdentifier:t,options:s={}}){let i=this.instances.get(t);if(!i&&this.component&&(i=this.component.instanceFactory(this.container,{instanceIdentifier:jt(t),options:s}),this.instances.set(t,i),this.instancesOptions.set(t,s),this.invokeOnInitCallbacks(i,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,i)}catch{}return i||null}normalizeInstanceIdentifier(t=m){return this.component?this.component.multipleInstances?t:m:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function jt(e){return e===m?void 0:e}function Dt(e){return e.instantiationMode==="EAGER"}class Et{constructor(t){this.name=t,this.providers=new Map}addComponent(t){const s=this.getProvider(t.name);if(s.isComponentSet())throw new Error(`Component ${t.name} has already been registered with ${this.name}`);s.setComponent(t)}addOrOverwriteComponent(t){this.getProvider(t.name).isComponentSet()&&this.providers.delete(t.name),this.addComponent(t)}getProvider(t){if(this.providers.has(t))return this.providers.get(t);const s=new kt(t,this);return this.providers.set(t,s),s}getProviders(){return Array.from(this.providers.values())}}var o;(function(e){e[e.DEBUG=0]="DEBUG",e[e.VERBOSE=1]="VERBOSE",e[e.INFO=2]="INFO",e[e.WARN=3]="WARN",e[e.ERROR=4]="ERROR",e[e.SILENT=5]="SILENT"})(o||(o={}));const Ct={debug:o.DEBUG,verbose:o.VERBOSE,info:o.INFO,warn:o.WARN,error:o.ERROR,silent:o.SILENT},St=o.INFO,Tt={[o.DEBUG]:"log",[o.VERBOSE]:"log",[o.INFO]:"info",[o.WARN]:"warn",[o.ERROR]:"error"},Bt=(e,t,...s)=>{if(t<e.logLevel)return;const i=new Date().toISOString(),l=Tt[t];if(l)console[l](`[${i}]  ${e.name}:`,...s);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class Pt{constructor(t){this.name=t,this._logLevel=St,this._logHandler=Bt,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in o))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?Ct[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,o.DEBUG,...t),this._logHandler(this,o.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,o.VERBOSE,...t),this._logHandler(this,o.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,o.INFO,...t),this._logHandler(this,o.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,o.WARN,...t),this._logHandler(this,o.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,o.ERROR,...t),this._logHandler(this,o.ERROR,...t)}}const At=(e,t)=>t.some(s=>e instanceof s);let L,z;function Ot(){return L||(L=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function It(){return z||(z=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const tt=new WeakMap,P=new WeakMap,et=new WeakMap,D=new WeakMap,H=new WeakMap;function Mt(e){const t=new Promise((s,i)=>{const l=()=>{e.removeEventListener("success",a),e.removeEventListener("error",d)},a=()=>{s(f(e.result)),l()},d=()=>{i(e.error),l()};e.addEventListener("success",a),e.addEventListener("error",d)});return t.then(s=>{s instanceof IDBCursor&&tt.set(s,e)}).catch(()=>{}),H.set(t,e),t}function _t(e){if(P.has(e))return;const t=new Promise((s,i)=>{const l=()=>{e.removeEventListener("complete",a),e.removeEventListener("error",d),e.removeEventListener("abort",d)},a=()=>{s(),l()},d=()=>{i(e.error||new DOMException("AbortError","AbortError")),l()};e.addEventListener("complete",a),e.addEventListener("error",d),e.addEventListener("abort",d)});P.set(e,t)}let A={get(e,t,s){if(e instanceof IDBTransaction){if(t==="done")return P.get(e);if(t==="objectStoreNames")return e.objectStoreNames||et.get(e);if(t==="store")return s.objectStoreNames[1]?void 0:s.objectStore(s.objectStoreNames[0])}return f(e[t])},set(e,t,s){return e[t]=s,!0},has(e,t){return e instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in e}};function Ht(e){A=e(A)}function Ft(e){return e===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...s){const i=e.call(E(this),t,...s);return et.set(i,t.sort?t.sort():[t]),f(i)}:It().includes(e)?function(...t){return e.apply(E(this),t),f(tt.get(this))}:function(...t){return f(e.apply(E(this),t))}}function Rt(e){return typeof e=="function"?Ft(e):(e instanceof IDBTransaction&&_t(e),At(e,Ot())?new Proxy(e,A):e)}function f(e){if(e instanceof IDBRequest)return Mt(e);if(D.has(e))return D.get(e);const t=Rt(e);return t!==e&&(D.set(e,t),H.set(t,e)),t}const E=e=>H.get(e);function Yt(e,t,{blocked:s,upgrade:i,blocking:l,terminated:a}={}){const d=indexedDB.open(e,t),n=f(d);return i&&d.addEventListener("upgradeneeded",r=>{i(f(d.result),r.oldVersion,r.newVersion,f(d.transaction),r)}),s&&d.addEventListener("blocked",r=>s(r.oldVersion,r.newVersion,r)),n.then(r=>{a&&r.addEventListener("close",()=>a()),l&&r.addEventListener("versionchange",c=>l(c.oldVersion,c.newVersion,c))}).catch(()=>{}),n}const Lt=["get","getKey","getAll","getAllKeys","count"],zt=["put","add","delete","clear"],C=new Map;function $(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t=="string"))return;if(C.get(t))return C.get(t);const s=t.replace(/FromIndex$/,""),i=t!==s,l=zt.includes(s);if(!(s in(i?IDBIndex:IDBObjectStore).prototype)||!(l||Lt.includes(s)))return;const a=async function(d,...n){const r=this.transaction(d,l?"readwrite":"readonly");let c=r.store;return i&&(c=c.index(n.shift())),(await Promise.all([c[s](...n),l&&r.done]))[0]};return C.set(t,a),a}Ht(e=>({...e,get:(t,s,i)=>$(t,s)||e.get(t,s,i),has:(t,s)=>!!$(t,s)||e.has(t,s)}));class $t{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(s=>{if(Nt(s)){const i=s.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(s=>s).join(" ")}}function Nt(e){return e.getComponent()?.type==="VERSION"}const O="@firebase/app",N="0.14.6";const b=new Pt("@firebase/app"),qt="@firebase/app-compat",Ut="@firebase/analytics-compat",Vt="@firebase/analytics",Wt="@firebase/app-check-compat",Xt="@firebase/app-check",Gt="@firebase/auth",Kt="@firebase/auth-compat",Jt="@firebase/database",Qt="@firebase/data-connect",Zt="@firebase/database-compat",te="@firebase/functions",ee="@firebase/functions-compat",se="@firebase/installations",ie="@firebase/installations-compat",le="@firebase/messaging",ae="@firebase/messaging-compat",de="@firebase/performance",ce="@firebase/performance-compat",re="@firebase/remote-config",ne="@firebase/remote-config-compat",oe="@firebase/storage",xe="@firebase/storage-compat",be="@firebase/firestore",pe="@firebase/ai",fe="@firebase/firestore-compat",me="firebase";const ve="[DEFAULT]",he={[O]:"fire-core",[qt]:"fire-core-compat",[Vt]:"fire-analytics",[Ut]:"fire-analytics-compat",[Xt]:"fire-app-check",[Wt]:"fire-app-check-compat",[Gt]:"fire-auth",[Kt]:"fire-auth-compat",[Jt]:"fire-rtdb",[Qt]:"fire-data-connect",[Zt]:"fire-rtdb-compat",[te]:"fire-fn",[ee]:"fire-fn-compat",[se]:"fire-iid",[ie]:"fire-iid-compat",[le]:"fire-fcm",[ae]:"fire-fcm-compat",[de]:"fire-perf",[ce]:"fire-perf-compat",[re]:"fire-rc",[ne]:"fire-rc-compat",[oe]:"fire-gcs",[xe]:"fire-gcs-compat",[be]:"fire-fst",[fe]:"fire-fst-compat",[pe]:"fire-vertex","fire-js":"fire-js",[me]:"fire-js-all"};const I=new Map,ue=new Map,M=new Map;function q(e,t){try{e.container.addComponent(t)}catch(s){b.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,s)}}function _(e){const t=e.name;if(M.has(t))return b.debug(`There were multiple attempts to register component ${t}.`),!1;M.set(t,e);for(const s of I.values())q(s,e);for(const s of ue.values())q(s,e);return!0}const ge={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}'","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","server-app-deleted":"Firebase Server App has been deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}.","finalization-registry-not-supported":"FirebaseServerApp deleteOnDeref field defined but the JS runtime does not support FinalizationRegistry.","invalid-server-app-environment":"FirebaseServerApp is not for use in browser environments."},v=new Z("app","Firebase",ge);class we{constructor(t,s,i){this._isDeleted=!1,this._options={...t},this._config={...s},this._name=s.name,this._automaticDataCollectionEnabled=s.automaticDataCollectionEnabled,this._container=i,this.container.addComponent(new j("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(t){this.checkDestroyed(),this._automaticDataCollectionEnabled=t}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(t){this._isDeleted=t}checkDestroyed(){if(this.isDeleted)throw v.create("app-deleted",{appName:this._name})}}function ye(e,t={}){let s=e;typeof t!="object"&&(t={name:t});const i={name:ve,automaticDataCollectionEnabled:!0,...t},l=i.name;if(typeof l!="string"||!l)throw v.create("bad-app-name",{appName:String(l)});if(s||(s=mt()),!s)throw v.create("no-options");const a=I.get(l);if(a){if(B(s,a.options)&&B(i,a.config))return a;throw v.create("duplicate-app",{appName:l})}const d=new Et(l);for(const r of M.values())d.addComponent(r);const n=new we(s,i,d);return I.set(l,n),n}function k(e,t,s){let i=he[e]??e;s&&(i+=`-${s}`);const l=i.match(/\s|\//),a=t.match(/\s|\//);if(l||a){const d=[`Unable to register library "${i}" with version "${t}":`];l&&d.push(`library name "${i}" contains illegal characters (whitespace or "/")`),l&&a&&d.push("and"),a&&d.push(`version name "${t}" contains illegal characters (whitespace or "/")`),b.warn(d.join(" "));return}_(new j(`${i}-version`,()=>({library:i,version:t}),"VERSION"))}const ke="firebase-heartbeat-database",je=1,h="firebase-heartbeat-store";let S=null;function st(){return S||(S=Yt(ke,je,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(h)}catch(s){console.warn(s)}}}}).catch(e=>{throw v.create("idb-open",{originalErrorMessage:e.message})})),S}async function De(e){try{const s=(await st()).transaction(h),i=await s.objectStore(h).get(it(e));return await s.done,i}catch(t){if(t instanceof g)b.warn(t.message);else{const s=v.create("idb-get",{originalErrorMessage:t?.message});b.warn(s.message)}}}async function U(e,t){try{const i=(await st()).transaction(h,"readwrite");await i.objectStore(h).put(t,it(e)),await i.done}catch(s){if(s instanceof g)b.warn(s.message);else{const i=v.create("idb-set",{originalErrorMessage:s?.message});b.warn(i.message)}}}function it(e){return`${e.name}!${e.options.appId}`}const Ee=1024,Ce=30;class Se{constructor(t){this.container=t,this._heartbeatsCache=null;const s=this.container.getProvider("app").getImmediate();this._storage=new Be(s),this._heartbeatsCachePromise=this._storage.read().then(i=>(this._heartbeatsCache=i,i))}async triggerHeartbeat(){try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=V();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(l=>l.date===i))return;if(this._heartbeatsCache.heartbeats.push({date:i,agent:s}),this._heartbeatsCache.heartbeats.length>Ce){const l=Pe(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(l,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(t){b.warn(t)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=V(),{heartbeatsToSend:s,unsentEntries:i}=Te(this._heartbeatsCache.heartbeats),l=Q(JSON.stringify({version:2,heartbeats:s}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),l}catch(t){return b.warn(t),""}}}function V(){return new Date().toISOString().substring(0,10)}function Te(e,t=Ee){const s=[];let i=e.slice();for(const l of e){const a=s.find(d=>d.agent===l.agent);if(a){if(a.dates.push(l.date),W(s)>t){a.dates.pop();break}}else if(s.push({agent:l.agent,dates:[l.date]}),W(s)>t){s.pop();break}i=i.slice(1)}return{heartbeatsToSend:s,unsentEntries:i}}class Be{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return ht()?ut().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const s=await De(this.app);return s?.heartbeats?s:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){if(await this._canUseIndexedDBPromise){const i=await this.read();return U(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){if(await this._canUseIndexedDBPromise){const i=await this.read();return U(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...t.heartbeats]})}else return}}function W(e){return Q(JSON.stringify({version:2,heartbeats:e})).length}function Pe(e){if(e.length===0)return-1;let t=0,s=e[0].date;for(let i=1;i<e.length;i++)e[i].date<s&&(s=e[i].date,t=i);return t}function Ae(e){_(new j("platform-logger",t=>new $t(t),"PRIVATE")),_(new j("heartbeat",t=>new Se(t),"PRIVATE")),k(O,N,e),k(O,N,"esm2020"),k("fire-js","")}Ae("");var Oe="firebase",Ie="12.6.0";k(Oe,Ie,"app");const T=new Map;function Me(e,t={}){const{cacheBusterKey:s="_ts"}=t;return new Promise((i,l)=>{if(e.src){const d=new URL(e.src,document.baseURI).href;let n=T.get(d);if(!n){const r=new URL(d);r.searchParams.set(s,Date.now().toString()),n=fetch(r.toString()).then(c=>{if(!c.ok)throw new Error(`Failed to fetch script: ${c.url} ${c.status} ${c.statusText}`);return c.text()}),T.set(d,n)}n.then(r=>{const c=document.createElement("script");e.type&&(c.type=e.type),e.async&&(c.async=e.async),e.defer&&(c.defer=e.defer),e.crossOrigin!==null&&(c.crossOrigin=e.crossOrigin);const p=new Blob([r],{type:"text/javascript"}),x=URL.createObjectURL(p);c.src=x,c.dataset.originalSrc=e.src,c.onload=()=>{URL.revokeObjectURL(x),i(c)},c.onerror=()=>{URL.revokeObjectURL(x),l(new Error(`Failed to load script from blob: ${e.src}`))},document.head.appendChild(c)}).catch(r=>{T.delete(d),l(r)});return}const a=document.createElement("script");e.type&&(a.type=e.type),a.textContent=e.textContent??"",document.head.appendChild(a),i(a)})}async function _e(e={}){const{concurrency:t=5,removeOriginal:s=!0,filter:i}=e,l=Array.from(document.head.querySelectorAll("script")).filter(c=>!(i&&!i(c))),a=[];let d=0;async function n(){for(;d<l.length;){const c=d++,p=l[c];try{if(await Me(p,e),s)try{p.parentElement?.removeChild(p)}catch{}}catch(x){console.error("Script reload error:",x)}}}const r=Math.max(1,Math.min(t,l.length));for(let c=0;c<r;c++)a.push(n());await Promise.all(a)}console.log("main.ts 실행됨");function He(e){const t=`${e}%`;document.body.style.zoom=t}function Fe(e){const t=e.match(/<head\b[^>]*>([\s\S]*?)<\/head>/i);return t?t[1]:""}function Re(e){const t=e.match(/<body\b[^>]*>([\s\S]*?)<\/body>/i);return t?t[1]:""}function Ye(e){function t(s){(s.code==="PageDown"||s.key==="PageDown"||s.keyCode===34)&&e(s)}return window.addEventListener("keydown",t),()=>{window.removeEventListener("keydown",t)}}function Le(e){function t(s){(s.code==="PageUp"||s.key==="PageUp"||s.keyCode===33)&&e(s)}return window.addEventListener("keydown",t),()=>{window.removeEventListener("keydown",t)}}const X=G.length-1;let u=0;async function F(e=0){console.log("changePage 실행"),e>X?e=0:e<0&&(e=X),u=e;let t=G[e];t=t.replace(/AAAA/g,"`"),t=t.replace(/BBBB/g,"${"),document.head.innerHTML=Fe(t),document.body.innerHTML=Re(t);try{await _e({cacheBusterKey:"_r",concurrency:3,removeOriginal:!0}),console.log("Head scripts reloaded")}catch(s){console.error(s)}}Le(e=>{e.preventDefault(),u--,F(u)});Ye(e=>{e.preventDefault(),u++,F(u)});const ze={apiKey:"AIzaSyDwQBfBU1ktxAYT8t2Ee4h-skM9M8jvGGI",authDomain:"civil-act-slides.firebaseapp.com",projectId:"civil-act-slides",storageBucket:"civil-act-slides.firebasestorage.app",messagingSenderId:"224199581514",appId:"1:224199581514:web:579053596871a9d3b9ebb3"};ye(ze);function $e(){He(150),F()}$e();
