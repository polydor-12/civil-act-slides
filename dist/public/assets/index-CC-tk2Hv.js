...
`],dt=()=>{};var R={};const J=function(e){const t=[];let s=0;for(let i=0;i<e.length;i++){let l=e.charCodeAt(i);l<128?t[s++]=l:l<2048?(t[s++]=l>>6|192,t[s++]=l&63|128):(l&64512)===55296&&i+1<e.length&&(e.charCodeAt(i+1)&64512)===56320?(l=65536+((l&1023)<<10)+(e.charCodeAt(++i)&1023),t[s++]=l>>18|240,t[s++]=l>>12&63|128,t[s++]=l>>6&63|128,t[s++]=l&63|128):(t[s++]=l>>12|224,t[s++]=l>>6&63|128,t[s++]=l&63|128)}return t},ct=function(e){const t=[];let s=0,i=0;for(;s<e.length;){const l=e[s++];if(l<128)t[i++]=String.fromCharCode(l);else if(l>191&&l<224){const a=e[s++];t[i++]=String.fromCharCode((l&31)<<6|a&63)}else if(l>239&&l<365){const a=e[s++],d=e[s++],n=e[s++],r=((l&7)<<18|(a&63)<<12|(d&63)<<6|n&63)-65536;t[i++]=String.fromCharCode(55296+(r>>10)),t[i++]=String.fromCharCode(56320+(r&1023))}else{const a=e[s++],d=e[s++];t[i++]=String.fromCharCode((l&15)<<12|(a&63)<<6|d&63)}}return t.join("")},Q={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(e,t){if(!Array.isArray(e))throw Error("encodeByteArray takes an array as a parameter");this.init_();const s=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,i=[];for(let l=0;l<e.length;l+=3){const a=e[l],d=l+1<e.length,n=d?e[l+1]:0,r=l+2<e.length,c=r?e[l+2]:0,x=a>>2,b=(a&3)<<4|n>>4;let w=(n&15)<<2|c>>6,y=c&63;r||(y=64,d||(w=64)),i.push(s[x],s[b],s[w],s[y])}return i.join("")},encodeString(e,t){return this.HAS_NATIVE_SUPPORT&&!t?btoa(e):this.encodeByteArray(J(e),t)},decodeString(e,t){return this.HAS_NATIVE_SUPPORT&&!t?atob(e):ct(this.decodeStringToByteArray(e,t))},decodeStringToByteArray(e,t){this.init_();const s=t?this.charToByteMapWebSafe_:this.charToByteMap_,i=[];for(let l=0;l<e.length;){const a=s[e.charAt(l++)],n=l<e.length?s[e.charAt(l)]:0;++l;const c=l<e.length?s[e.charAt(l)]:64;++l;const b=l<e.length?s[e.charAt(l)]:64;if(++l,a==null||n==null||c==null||b==null)throw new rt;const w=a<<2|n>>4;if(i.push(w),c!==64){const y=n<<4&240|c>>2;if(i.push(y),b!==64){const at=c<<6&192|b;i.push(at)}}}return i},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let e=0;e<this.ENCODED_VALS.length;e++)this.byteToCharMap_[e]=this.ENCODED_VALS.charAt(e),this.charToByteMap_[this.byteToCharMap_[e]]=e,this.byteToCharMapWebSafe_[e]=this.ENCODED_VALS_WEBSAFE.charAt(e),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[e]]=e,e>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(e)]=e,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(e)]=e)}}};class rt extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const nt=function(e){const t=J(e);return Q.encodeByteArray(t,!0)},Z=function(e){return nt(e).replace(/\./g,"")},ot=function(e){try{return Q.decodeString(e,!0)}catch(t){console.error("base64Decode failed: ",t)}return null};function xt(){if(typeof self<"u")return self;if(typeof window<"u")return window;if(typeof global<"u")return global;throw new Error("Unable to locate global object.")}const bt=()=>xt().__FIREBASE_DEFAULTS__,pt=()=>{if(typeof process>"u"||typeof R>"u")return;const e=R.__FIREBASE_DEFAULTS__;if(e)return JSON.parse(e)},ft=()=>{if(typeof document>"u")return;let e;try{e=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=e&&ot(e[1]);return t&&JSON.parse(t)},mt=()=>{try{return dt()||bt()||pt()||ft()}catch(e){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${e}`);return}},vt=()=>mt()?.config;class ht{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise((t,s)=>{this.resolve=t,this.reject=s})}wrapCallback(t){return(s,i)=>{s?this.reject(s):this.resolve(i),typeof t=="function"&&(this.promise.catch(()=>{}),t.length===1?t(s):t(s,i))}}}function ut(){try{return typeof indexedDB=="object"}catch{return!1}}function gt(){return new Promise((e,t)=>{try{let s=!0;const i="validate-browser-context-for-indexeddb-analytics-module",l=self.indexedDB.open(i);l.onsuccess=()=>{l.result.close(),s||self.indexedDB.deleteDatabase(i),e(!0)},l.onupgradeneeded=()=>{s=!1},l.onerror=()=>{t(l.error?.message||"")}}catch(s){t(s)}})}const wt="FirebaseError";class g extends Error{constructor(t,s,i){super(s),this.code=t,this.customData=i,this.name=wt,Object.setPrototypeOf(this,g.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,tt.prototype.create)}}class tt{constructor(t,s,i){this.service=t,this.serviceName=s,this.errors=i}create(t,...s){const i=s[0]||{},l=`${this.service}/${t}`,a=this.errors[t],d=a?yt(a,i):"Error",n=`${this.serviceName}: ${d} (${l}).`;return new g(l,n,i)}}function yt(e,t){return e.replace(kt,(s,i)=>{const l=t[i];return l!=null?String(l):`<${i}?>`})}const kt=/\{\$([^}]+)}/g;function B(e,t){if(e===t)return!0;const s=Object.keys(e),i=Object.keys(t);for(const l of s){if(!i.includes(l))return!1;const a=e[l],d=t[l];if(Y(a)&&Y(d)){if(!B(a,d))return!1}else if(a!==d)return!1}for(const l of i)if(!s.includes(l))return!1;return!0}function Y(e){return e!==null&&typeof e=="object"}class j{constructor(t,s,i){this.name=t,this.instanceFactory=s,this.type=i,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}const m="[DEFAULT]";class jt{constructor(t,s){this.name=t,this.container=s,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const s=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(s)){const i=new ht;if(this.instancesDeferred.set(s,i),this.isInitialized(s)||this.shouldAutoInitialize())try{const l=this.getOrInitializeService({instanceIdentifier:s});l&&i.resolve(l)}catch{}}return this.instancesDeferred.get(s).promise}getImmediate(t){const s=this.normalizeInstanceIdentifier(t?.identifier),i=t?.optional??!1;if(this.isInitialized(s)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:s})}catch(l){if(i)return null;throw l}else{if(i)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(Et(t))try{this.getOrInitializeService({instanceIdentifier:m})}catch{}for(const[s,i]of this.instancesDeferred.entries()){const l=this.normalizeInstanceIdentifier(s);try{const a=this.getOrInitializeService({instanceIdentifier:l});i.resolve(a)}catch{}}}}clearInstance(t=m){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(s=>"INTERNAL"in s).map(s=>s.INTERNAL.delete()),...t.filter(s=>"_delete"in s).map(s=>s._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=m){return this.instances.has(t)}getOptions(t=m){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:s={}}=t,i=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(i))throw Error(`${this.name}(${i}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const l=this.getOrInitializeService({instanceIdentifier:i,options:s});for(const[a,d]of this.instancesDeferred.entries()){const n=this.normalizeInstanceIdentifier(a);i===n&&d.resolve(l)}return l}onInit(t,s){const i=this.normalizeInstanceIdentifier(s),l=this.onInitCallbacks.get(i)??new Set;l.add(t),this.onInitCallbacks.set(i,l);const a=this.instances.get(i);return a&&t(a,i),()=>{l.delete(t)}}invokeOnInitCallbacks(t,s){const i=this.onInitCallbacks.get(s);if(i)for(const l of i)try{l(t,s)}catch{}}getOrInitializeService({instanceIdentifier:t,options:s={}}){let i=this.instances.get(t);if(!i&&this.component&&(i=this.component.instanceFactory(this.container,{instanceIdentifier:Dt(t),options:s}),this.instances.set(t,i),this.instancesOptions.set(t,s),this.invokeOnInitCallbacks(i,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,i)}catch{}return i||null}normalizeInstanceIdentifier(t=m){return this.component?this.component.multipleInstances?t:m:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function Dt(e){return e===m?void 0:e}function Et(e){return e.instantiationMode==="EAGER"}class Ct{constructor(t){this.name=t,this.providers=new Map}addComponent(t){const s=this.getProvider(t.name);if(s.isComponentSet())throw new Error(`Component ${t.name} has already been registered with ${this.name}`);s.setComponent(t)}addOrOverwriteComponent(t){this.getProvider(t.name).isComponentSet()&&this.providers.delete(t.name),this.addComponent(t)}getProvider(t){if(this.providers.has(t))return this.providers.get(t);const s=new jt(t,this);return this.providers.set(t,s),s}getProviders(){return Array.from(this.providers.values())}}var o;(function(e){e[e.DEBUG=0]="DEBUG",e[e.VERBOSE=1]="VERBOSE",e[e.INFO=2]="INFO",e[e.WARN=3]="WARN",e[e.ERROR=4]="ERROR",e[e.SILENT=5]="SILENT"})(o||(o={}));const St={debug:o.DEBUG,verbose:o.VERBOSE,info:o.INFO,warn:o.WARN,error:o.ERROR,silent:o.SILENT},Tt=o.INFO,Bt={[o.DEBUG]:"log",[o.VERBOSE]:"log",[o.INFO]:"info",[o.WARN]:"warn",[o.ERROR]:"error"},Pt=(e,t,...s)=>{if(t<e.logLevel)return;const i=new Date().toISOString(),l=Bt[t];if(l)console[l](`[${i}]  ${e.name}:`,...s);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class At{constructor(t){this.name=t,this._logLevel=Tt,this._logHandler=Pt,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in o))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?St[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,o.DEBUG,...t),this._logHandler(this,o.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,o.VERBOSE,...t),this._logHandler(this,o.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,o.INFO,...t),this._logHandler(this,o.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,o.WARN,...t),this._logHandler(this,o.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,o.ERROR,...t),this._logHandler(this,o.ERROR,...t)}}const Ot=(e,t)=>t.some(s=>e instanceof s);let L,z;function It(){return L||(L=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Mt(){return z||(z=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const et=new WeakMap,P=new WeakMap,st=new WeakMap,D=new WeakMap,H=new WeakMap;function _t(e){const t=new Promise((s,i)=>{const l=()=>{e.removeEventListener("success",a),e.removeEventListener("error",d)},a=()=>{s(f(e.result)),l()},d=()=>{i(e.error),l()};e.addEventListener("success",a),e.addEventListener("error",d)});return t.then(s=>{s instanceof IDBCursor&&et.set(s,e)}).catch(()=>{}),H.set(t,e),t}function Ht(e){if(P.has(e))return;const t=new Promise((s,i)=>{const l=()=>{e.removeEventListener("complete",a),e.removeEventListener("error",d),e.removeEventListener("abort",d)},a=()=>{s(),l()},d=()=>{i(e.error||new DOMException("AbortError","AbortError")),l()};e.addEventListener("complete",a),e.addEventListener("error",d),e.addEventListener("abort",d)});P.set(e,t)}let A={get(e,t,s){if(e instanceof IDBTransaction){if(t==="done")return P.get(e);if(t==="objectStoreNames")return e.objectStoreNames||st.get(e);if(t==="store")return s.objectStoreNames[1]?void 0:s.objectStore(s.objectStoreNames[0])}return f(e[t])},set(e,t,s){return e[t]=s,!0},has(e,t){return e instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in e}};function Ft(e){A=e(A)}function Rt(e){return e===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...s){const i=e.call(E(this),t,...s);return st.set(i,t.sort?t.sort():[t]),f(i)}:Mt().includes(e)?function(...t){return e.apply(E(this),t),f(et.get(this))}:function(...t){return f(e.apply(E(this),t))}}function Yt(e){return typeof e=="function"?Rt(e):(e instanceof IDBTransaction&&Ht(e),Ot(e,It())?new Proxy(e,A):e)}function f(e){if(e instanceof IDBRequest)return _t(e);if(D.has(e))return D.get(e);const t=Yt(e);return t!==e&&(D.set(e,t),H.set(t,e)),t}const E=e=>H.get(e);function Lt(e,t,{blocked:s,upgrade:i,blocking:l,terminated:a}={}){const d=indexedDB.open(e,t),n=f(d);return i&&d.addEventListener("upgradeneeded",r=>{i(f(d.result),r.oldVersion,r.newVersion,f(d.transaction),r)}),s&&d.addEventListener("blocked",r=>s(r.oldVersion,r.newVersion,r)),n.then(r=>{a&&r.addEventListener("close",()=>a()),l&&r.addEventListener("versionchange",c=>l(c.oldVersion,c.newVersion,c))}).catch(()=>{}),n}const zt=["get","getKey","getAll","getAllKeys","count"],$t=["put","add","delete","clear"],C=new Map;function $(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t=="string"))return;if(C.get(t))return C.get(t);const s=t.replace(/FromIndex$/,""),i=t!==s,l=$t.includes(s);if(!(s in(i?IDBIndex:IDBObjectStore).prototype)||!(l||zt.includes(s)))return;const a=async function(d,...n){const r=this.transaction(d,l?"readwrite":"readonly");let c=r.store;return i&&(c=c.index(n.shift())),(await Promise.all([c[s](...n),l&&r.done]))[0]};return C.set(t,a),a}Ft(e=>({...e,get:(t,s,i)=>$(t,s)||e.get(t,s,i),has:(t,s)=>!!$(t,s)||e.has(t,s)}));class Nt{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(s=>{if(qt(s)){const i=s.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(s=>s).join(" ")}}function qt(e){return e.getComponent()?.type==="VERSION"}const O="@firebase/app",N="0.14.6";const p=new At("@firebase/app"),Ut="@firebase/app-compat",Vt="@firebase/analytics-compat",Wt="@firebase/analytics",Xt="@firebase/app-check-compat",Gt="@firebase/app-check",Kt="@firebase/auth",Jt="@firebase/auth-compat",Qt="@firebase/database",Zt="@firebase/data-connect",te="@firebase/database-compat",ee="@firebase/functions",se="@firebase/functions-compat",ie="@firebase/installations",le="@firebase/installations-compat",ae="@firebase/messaging",de="@firebase/messaging-compat",ce="@firebase/performance",re="@firebase/performance-compat",ne="@firebase/remote-config",oe="@firebase/remote-config-compat",xe="@firebase/storage",be="@firebase/storage-compat",pe="@firebase/firestore",fe="@firebase/ai",me="@firebase/firestore-compat",ve="firebase";const he="[DEFAULT]",ue={[O]:"fire-core",[Ut]:"fire-core-compat",[Wt]:"fire-analytics",[Vt]:"fire-analytics-compat",[Gt]:"fire-app-check",[Xt]:"fire-app-check-compat",[Kt]:"fire-auth",[Jt]:"fire-auth-compat",[Qt]:"fire-rtdb",[Zt]:"fire-data-connect",[te]:"fire-rtdb-compat",[ee]:"fire-fn",[se]:"fire-fn-compat",[ie]:"fire-iid",[le]:"fire-iid-compat",[ae]:"fire-fcm",[de]:"fire-fcm-compat",[ce]:"fire-perf",[re]:"fire-perf-compat",[ne]:"fire-rc",[oe]:"fire-rc-compat",[xe]:"fire-gcs",[be]:"fire-gcs-compat",[pe]:"fire-fst",[me]:"fire-fst-compat",[fe]:"fire-vertex","fire-js":"fire-js",[ve]:"fire-js-all"};const I=new Map,ge=new Map,M=new Map;function q(e,t){try{e.container.addComponent(t)}catch(s){p.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,s)}}function _(e){const t=e.name;if(M.has(t))return p.debug(`There were multiple attempts to register component ${t}.`),!1;M.set(t,e);for(const s of I.values())q(s,e);for(const s of ge.values())q(s,e);return!0}const we={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}'","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","server-app-deleted":"Firebase Server App has been deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}.","finalization-registry-not-supported":"FirebaseServerApp deleteOnDeref field defined but the JS runtime does not support FinalizationRegistry.","invalid-server-app-environment":"FirebaseServerApp is not for use in browser environments."},v=new tt("app","Firebase",we);class ye{constructor(t,s,i){this._isDeleted=!1,this._options={...t},this._config={...s},this._name=s.name,this._automaticDataCollectionEnabled=s.automaticDataCollectionEnabled,this._container=i,this.container.addComponent(new j("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(t){this.checkDestroyed(),this._automaticDataCollectionEnabled=t}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(t){this._isDeleted=t}checkDestroyed(){if(this.isDeleted)throw v.create("app-deleted",{appName:this._name})}}function ke(e,t={}){let s=e;typeof t!="object"&&(t={name:t});const i={name:he,automaticDataCollectionEnabled:!0,...t},l=i.name;if(typeof l!="string"||!l)throw v.create("bad-app-name",{appName:String(l)});if(s||(s=vt()),!s)throw v.create("no-options");const a=I.get(l);if(a){if(B(s,a.options)&&B(i,a.config))return a;throw v.create("duplicate-app",{appName:l})}const d=new Ct(l);for(const r of M.values())d.addComponent(r);const n=new ye(s,i,d);return I.set(l,n),n}function k(e,t,s){let i=ue[e]??e;s&&(i+=`-${s}`);const l=i.match(/\s|\//),a=t.match(/\s|\//);if(l||a){const d=[`Unable to register library "${i}" with version "${t}":`];l&&d.push(`library name "${i}" contains illegal characters (whitespace or "/")`),l&&a&&d.push("and"),a&&d.push(`version name "${t}" contains illegal characters (whitespace or "/")`),p.warn(d.join(" "));return}_(new j(`${i}-version`,()=>({library:i,version:t}),"VERSION"))}const je="firebase-heartbeat-database",De=1,h="firebase-heartbeat-store";let S=null;function it(){return S||(S=Lt(je,De,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(h)}catch(s){console.warn(s)}}}}).catch(e=>{throw v.create("idb-open",{originalErrorMessage:e.message})})),S}async function Ee(e){try{const s=(await it()).transaction(h),i=await s.objectStore(h).get(lt(e));return await s.done,i}catch(t){if(t instanceof g)p.warn(t.message);else{const s=v.create("idb-get",{originalErrorMessage:t?.message});p.warn(s.message)}}}async function U(e,t){try{const i=(await it()).transaction(h,"readwrite");await i.objectStore(h).put(t,lt(e)),await i.done}catch(s){if(s instanceof g)p.warn(s.message);else{const i=v.create("idb-set",{originalErrorMessage:s?.message});p.warn(i.message)}}}function lt(e){return`${e.name}!${e.options.appId}`}const Ce=1024,Se=30;class Te{constructor(t){this.container=t,this._heartbeatsCache=null;const s=this.container.getProvider("app").getImmediate();this._storage=new Pe(s),this._heartbeatsCachePromise=this._storage.read().then(i=>(this._heartbeatsCache=i,i))}async triggerHeartbeat(){try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=V();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(l=>l.date===i))return;if(this._heartbeatsCache.heartbeats.push({date:i,agent:s}),this._heartbeatsCache.heartbeats.length>Se){const l=Ae(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(l,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(t){p.warn(t)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=V(),{heartbeatsToSend:s,unsentEntries:i}=Be(this._heartbeatsCache.heartbeats),l=Z(JSON.stringify({version:2,heartbeats:s}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),l}catch(t){return p.warn(t),""}}}function V(){return new Date().toISOString().substring(0,10)}function Be(e,t=Ce){const s=[];let i=e.slice();for(const l of e){const a=s.find(d=>d.agent===l.agent);if(a){if(a.dates.push(l.date),W(s)>t){a.dates.pop();break}}else if(s.push({agent:l.agent,dates:[l.date]}),W(s)>t){s.pop();break}i=i.slice(1)}return{heartbeatsToSend:s,unsentEntries:i}}class Pe{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return ut()?gt().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const s=await Ee(this.app);return s?.heartbeats?s:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){if(await this._canUseIndexedDBPromise){const i=await this.read();return U(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){if(await this._canUseIndexedDBPromise){const i=await this.read();return U(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...t.heartbeats]})}else return}}function W(e){return Z(JSON.stringify({version:2,heartbeats:e})).length}function Ae(e){if(e.length===0)return-1;let t=0,s=e[0].date;for(let i=1;i<e.length;i++)e[i].date<s&&(s=e[i].date,t=i);return t}function Oe(e){_(new j("platform-logger",t=>new Nt(t),"PRIVATE")),_(new j("heartbeat",t=>new Te(t),"PRIVATE")),k(O,N,e),k(O,N,"esm2020"),k("fire-js","")}Oe("");var Ie="firebase",Me="12.6.0";k(Ie,Me,"app");const X=new Set,T=new Map;function _e(e,t={}){const{cacheBusterKey:s="_ts"}=t;return new Promise((i,l)=>{if(e.src){const d=new URL(e.src,document.baseURI).href;let n=T.get(d);if(!n){const r=new URL(d);r.searchParams.set(s,Date.now().toString()),n=fetch(r.toString()).then(c=>{if(!c.ok)throw new Error(`Failed to fetch script: ${c.url} ${c.status} ${c.statusText}`);return c.text()}),T.set(d,n)}n.then(r=>{const c=document.createElement("script");e.type&&(c.type=e.type),e.async&&(c.async=e.async),e.defer&&(c.defer=e.defer),e.crossOrigin!==null&&(c.crossOrigin=e.crossOrigin);const x=new Blob([r],{type:"text/javascript"}),b=URL.createObjectURL(x);c.src=b,c.dataset.originalSrc=e.src,c.onload=()=>{URL.revokeObjectURL(b),i(c)},c.onerror=()=>{URL.revokeObjectURL(b),l(new Error(`Failed to load script from blob: ${e.src}`))},document.head.appendChild(c)}).catch(r=>{T.delete(d),l(r)});return}const a=document.createElement("script");e.type&&(a.type=e.type),a.textContent=e.textContent??"",document.head.appendChild(a),i(a)})}async function He(e={}){const{concurrency:t=5,removeOriginal:s=!0,filter:i}=e,l=Array.from(document.head.querySelectorAll("script")).filter(c=>{if(i&&!i(c)||c.dataset.originalSrc)return!1;const x=c.src?new URL(c.src,document.baseURI).href:c.textContent?.trim();return!(x&&X.has(x))}),a=[];let d=0;async function n(){for(;d<l.length;){const c=d++,x=l[c];try{await _e(x,e);const b=x.src?new URL(x.src,document.baseURI).href:x.textContent?.trim();if(b&&X.add(b),s)try{x.parentElement?.removeChild(x)}catch{}}catch(b){console.error("Script reload error:",b)}}}const r=Math.max(1,Math.min(t,l.length));for(let c=0;c<r;c++)a.push(n());await Promise.all(a)}console.log("main.ts 실행됨");function Fe(e){const t=`${e}%`;document.body.style.zoom=t}function Re(e){const t=e.match(/<head\b[^>]*>([\s\S]*?)<\/head>/i);return t?t[1]:""}function Ye(e){const t=e.match(/<body\b[^>]*>([\s\S]*?)<\/body>/i);return t?t[1]:""}function Le(e){function t(s){(s.code==="PageDown"||s.key==="PageDown"||s.keyCode===34)&&e(s)}return window.addEventListener("keydown",t),()=>{window.removeEventListener("keydown",t)}}function ze(e){function t(s){(s.code==="PageUp"||s.key==="PageUp"||s.keyCode===33)&&e(s)}return window.addEventListener("keydown",t),()=>{window.removeEventListener("keydown",t)}}const G=K.length-1;let u=0;async function F(e=0){console.log("changePage 실행"),e>G?e=0:e<0&&(e=G),u=e;let t=K[e];t=t.replace(/AAAA/g,"`"),t=t.replace(/BBBB/g,"${"),document.head.innerHTML=Re(t),document.body.innerHTML=Ye(t);try{await He({cacheBusterKey:"_r",concurrency:3,removeOriginal:!0}),console.log("Head scripts reloaded")}catch(s){console.error(s)}}ze(e=>{e.preventDefault(),u--,F(u)});Le(e=>{e.preventDefault(),u++,F(u)});const $e={apiKey:"AIzaSyDwQBfBU1ktxAYT8t2Ee4h-skM9M8jvGGI",authDomain:"civil-act-slides.firebaseapp.com",projectId:"civil-act-slides",storageBucket:"civil-act-slides.firebasestorage.app",messagingSenderId:"224199581514",appId:"1:224199581514:web:579053596871a9d3b9ebb3"};ke($e);function Ne(){Fe(150),F()}Ne();
