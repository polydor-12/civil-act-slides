...
</style>`;console.log("main.ts 실행됨");function _e(e){const t=e.match(/<head\b[^>]*>([\s\S]*?)<\/head>/i);return t?t[1]:""}function ze(e){const t=e.match(/<body\b[^>]*>([\s\S]*?)<\/body>/i);return t?t[1]:""}function Fe(e){function t(s){(s.code==="PageDown"||s.key==="PageDown"||s.keyCode===34)&&e(s)}return window.addEventListener("keydown",t),()=>{window.removeEventListener("keydown",t)}}function He(e){function t(s){(s.code==="PageUp"||s.key==="PageUp"||s.keyCode===33)&&e(s)}return window.addEventListener("keydown",t),()=>{window.removeEventListener("keydown",t)}}const W=G.length-1;let h=0;function _(e=0){e>W?e=0:e<0&&(e=W),h=e;let t=G[e];t=t.replace(/AAAA/g,"`"),t=t.replace(/BBBB/g,"${"),t=t.replace('<script src="https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4"><\/script>',Me),document.head.innerHTML=_e(t),document.body.innerHTML=ze(t)}He(e=>{e.preventDefault(),h--,_(h)});Fe(e=>{e.preventDefault(),h++,_(h)});const Ye={apiKey:"AIzaSyDwQBfBU1ktxAYT8t2Ee4h-skM9M8jvGGI",authDomain:"civil-act-slides.firebaseapp.com",projectId:"civil-act-slides",storageBucket:"civil-act-slides.firebasestorage.app",messagingSenderId:"224199581514",appId:"1:224199581514:web:579053596871a9d3b9ebb3"};let X="";ye(Ye);async function Re(){X=await(await fetch("https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4")).text(),console.log(X),_()}Re();
